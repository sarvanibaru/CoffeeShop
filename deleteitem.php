<html>
    ...
    <body>
        ...
        <div id = "delete_item" style="margin:auto">
            ...
            <div class="wrapper">
                ...
                <form class="form-signin" action="deletion.php" method="post">
                    ...
                    <p style="font-size: 20px;font-family: 'Spicy Rice', cursive;padding-left: 40px;">Enter Item ID of the item to be Deleted from Inventory, use search below if you are unsure of exact item id</p>
                    <label for="Item ID of Item to be Deleted:">Enter Item ID:</label>
                    <input type="number" id="itemid" name="itemid" class="form-control" required="" autofocus=""/>
                    <br>
                    <br>
                    <br>
                    <br>
                    <input type="submit" name="delete_item" id="delete_item" value="Click to Delete Item from Inventory" style="color:red ;background-color:lightyellow"> <br><br>
                    <div id="tab"></div>
